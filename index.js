/**
 * EliTechWiz-V3 - A WhatsApp Bot
 * Copyright (c) 2025 EliTechWiz
 * 
 ...
 * - Pair Code implementation inspired by EliTechWiz
 */
require('./settings')
...
async function startXeonBotInc() {
    ...
    XeonBotInc.ev.on('connection.update', async (s) => {
        ...
        if (connection == "open") {
            ...
            await delay(1999)
            console.log(chalk.yellow(`\n\n                  ${chalk.bold.blue(`[ ${global.botname || 'EliTechWiz-V3'} ]`)}\n\n`))
            console.log(chalk.cyan(`< ================================================== >`))
            console.log(chalk.magenta(`\n${global.themeemoji || '•'} YT CHANNEL: EliTechWiz`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} GITHUB: Eliahhango`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} WA NUMBER: ${owner}`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} CREDIT: EliTechWiz`))
